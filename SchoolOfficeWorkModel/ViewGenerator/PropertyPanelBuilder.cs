...
namespace ViewGenerator
{
    ...
    public class PropertyPanelBuilder
    {
        ...
        // частный конструктор
        private PropertyPanelBuilder(Form form)
        {
            _form = form;
        }
        ...
        private void FillCombobox(object userModel, object userClass, PropertyInfo prop, ComboBox comboBox)
        {
        ...
        /// <param name="userClass">объект со свойствами</param>
        /// <returns>Текст из дескриптора</returns>
        private static string GetClassCaption(object userClass)
        {
